...
//	}
	...
	public ArrayList<Meme> getMemesViewed() {
		ArrayList<Meme> memesViewed2 = new ArrayList<Meme>(memesViewed);
		return memesViewed2;
	
	}
	public void setMemesViewed(TreeSet<Meme> memesViewed) {
		TreeSet<Meme> memesViewed3 = new TreeSet<Meme>(memesViewed);
		this.memesViewed = memesViewed3;
	...
	public int compareTo(User o) {
		...
		int returnValue = this.username.compareTo(o.username);
		
		if (returnValue != 0) return returnValue;
		
		int a = this.memesCreated.size();
		int b  = o.memesCreated.size();
